...
class CarRearImage extends GetView<RegistrationController> {
  const CarRearImage({Key? key}) : super(key: key);
        ...
        () => InkWell(
          child: ClipRRect(
            ...
            child: Container(
              ...
              child: controller.driverCarBackImage.value.path.isNotEmpty
                  ? Stack(
                      children: [
                        ClipRRect(
                          borderRadius: BorderRadius.circular(10.0),
                          child: Image.file(
                            controller.driverCarBackImage.value,
                        ...
                        Positioned.fill(
                          child: Align(
                            ...
                            child: InkWell(
                              onTap: () async {
                                controller.driverCarBackImage.value = File('');
                              },
                              child: Container(
                                width: 30,
                                height: 30,
                            ...
                            child: InkWell(
                              onTap: () async {
                                Get.to(() => ShowImageByFile(
                                    url: controller.driverCarBackImage.value));
                              },
                              child: Container(
                                width: 30,
                                height: 30,
            ...
            showDialog(
              ...
              builder: (BuildContext context) => CupertinoAlertDialog(
                title: Container(
                  ...
                  child: Text(
                    'clearrearimageforthevehicle'.tr,
