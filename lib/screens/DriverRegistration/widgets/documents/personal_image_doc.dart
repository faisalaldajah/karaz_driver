...
class PersonalImageDoc extends GetView<RegistrationController> {
  const PersonalImageDoc({Key? key}) : super(key: key);
                  ...
                  ? Stack(
                      children: [
                        ClipRRect(
                          borderRadius: BorderRadius.circular(10.0),
                          child: Image.file(
                            controller.personalImageFile.value,
                        ...
                        Positioned.fill(
                          child: Align(
                            ...
                            child: InkWell(
                              onTap: () async {
                                controller.personalImageFile.value = File('');
                              },
                              child: Container(
                                width: 30,
                                height: 30,
                            ...
                            child: InkWell(
                              onTap: () async {
                                Get.to(() => ShowImageByFile(
                                    url: controller.personalImageFile.value));
                              },
                              child: Container(
                                width: 30,
                                height: 30,
