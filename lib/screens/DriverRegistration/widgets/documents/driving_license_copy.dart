...
class DrivingLicenseCopy extends GetView<RegistrationController> {
  const DrivingLicenseCopy({Key? key}) : super(key: key);
        ...
        () => InkWell(
          child: ClipRRect(
            ...
            child: Container(
              ...
              child: controller.driverLicenseImage.value.path.isNotEmpty
                  ? Stack(
                      children: [
                        ClipRRect(
                          borderRadius: BorderRadius.circular(10.0),
                        ...
                        Positioned.fill(
                          child: Align(
                            ...
                            child: InkWell(
                              onTap: () async {
                                controller.driverLicenseImage.value = File('');
                              },
                              child: Container(
                                width: 30,
                                height: 30,
                            ...
                            child: InkWell(
                              onTap: () async {
                                Get.to(() => ShowImageByFile(
                                    url: controller.driverLicenseImage.value));
                              },
                              child: Container(
                                width: 30,
                                height: 30,
